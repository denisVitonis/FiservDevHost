...
namespace xampCaseiro
{
    public partial class Form1 : Form
    {
        ...
        {
            // Obtém o caminho do PHP inserido pelo usuário
            ...
            // Determina o diretório onde o php.exe está localizado
            ...
            // Constrói o caminho para o php.ini
            string phpConfigPath = Path.Combine(phpDirectory, "php.ini");

            // Verifica se o arquivo php.ini existe
            if (File.Exists(phpConfigPath))
            {
                try
                {
                    // Abre o arquivo php.ini no Notepad
